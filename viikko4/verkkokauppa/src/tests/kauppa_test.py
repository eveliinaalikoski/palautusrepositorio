...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_eri_tuotetta_pankin_metodi_tilisiirto_kutsutaan_oikeilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", "33333-44455", 7)

    def test_ostetaan_kaksi_samaa_tuotetta_pankin_metodi_tilisiirto_kutsutaan_oikeilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_ostetaan_kaksi_tuotetta_toinen_loppu_pankin_metodi_tilisiirto_kutsutaan_oikeilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_ostoskorista_tuotteen_poisto_onnistuu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
